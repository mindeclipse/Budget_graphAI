...
export type PrivatCurrency = "UAH" | "USD" | "EUR" | "PLN";

export interface ParsedPrivatTransaction {
  external_id: string;
  amount: number;
  currency: PrivatCurrency;
  merchant_raw: string;
...
export const privatTransactionSchema = z.object({
...
export interface PrivatParseResult {
