...
3. Якщо користувач запитує: «Чи можу я дозволити собі покупку на X ₴?», детально порахуй це відносно залишку (${financialContext.remaining} ₴) та безпечного денного ліміту (${financialContext.safeDailySpend} ₴/день). Покажи, який новий денний ліміт у нього залишиться після покупки.
4. Якщо просять порад щодо оптимізації — звертай увагу на найбільші статті витрат або підписки.
