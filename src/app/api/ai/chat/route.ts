...
4. ВІДПОВІДІ НА ТИПОВІ ЗАПИТАННЯ КОРИСТУВАЧА:
   ...
   - Якщо питають: «Як оптимізувати найбільшу категорію?»: візьми першу категорію з топу витрат (${financialContext.topCategories?.[0]?.name || "найбільша категорія"}) і дай 2-3 практичні, реалістичні поради щодо оптимізації саме цієї статті без стресу.
